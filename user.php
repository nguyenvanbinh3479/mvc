...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="publics/img/msc-icon.png" />
    <link rel="icon" type="image/png" href="publics/img/msc-icon.png" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>M.S.C - User</title>
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img" src="publics/img/faces/marc.jpg" />
                                    </a>
                                </div>
                                <div class="content">
